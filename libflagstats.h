...
int FLAGSTAT_sse4_improved(const uint16_t* array, uint32_t len, uint32_t* flags) {
    ...
    const __m128i complete_bits_lookup = _mm_setr_epi8( // generated by masks.py
...
int FLAGSTAT_avx512_improved(const uint16_t* array, uint32_t len, uint32_t* flags) {
    ...
    // generated by masks.py
    const __m512i complete_bits_lookup = _mm512_setr_epi32(0x40000000, 0x50000000, 0x00000000, 0x00000000, 0x20000000, 0x30000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000);
